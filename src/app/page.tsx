    ...
    <MotionSection className="relative overflow-hidden border-b border-border/60">
      ...
      <Container className="relative flex min-h-[72vh] flex-col justify-center gap-10 py-14 lg:min-h-[82vh]">
        ...
        <div className="hidden gap-4 md:flex">
          <HeroThumb src="/hero.png" alt="Pamje nga xhamia" />
          <HeroThumb src="/xhamia.jpg" alt="Xhamia nga jashtë" />
          <HeroThumb src="/inside.jpg" alt="Brenda xhamisë" />
        </div>
      </Container>
    </MotionSection>
  );
...
function PrayerCard({
  ...
  return (
    <MotionCard className="relative overflow-hidden rounded-3xl border border-white/12 bg-black/35 p-4 text-zinc-50 shadow-[0_18px_60px_rgba(0,0,0,0.55)] backdrop-blur">
